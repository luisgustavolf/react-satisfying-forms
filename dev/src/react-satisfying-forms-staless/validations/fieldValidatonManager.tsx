import { IFieldValidator, FieldValidatorResult, FieldValidatorAssyncResult, FieldValidatorSyncResult } from "../interfaces/iFieldValidator";
...
export class FieldValidationManager {
    ...
    async validate(value: any, validators: IFieldValidator[], onError: (errors: string[]) => void, onComplete: (errors?: string[]) => void) {
    ...
    private executeValidators(value: any, validators: IFieldValidator[], onError: (error: string[]) => void) {
        this.reportedErrors = []
        this.lastValdationResults = [];
